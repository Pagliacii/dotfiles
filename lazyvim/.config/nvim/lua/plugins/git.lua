return {
...

  {
    ...
    opts = {
      ...
      mappings = {
        issue = {
          ...
          create_label = { lhs = "<leader>gOlc", desc = "create label" },
          add_label = { lhs = "<leader>gOla", desc = "add label" },
          remove_label = { lhs = "<leader>gOld", desc = "remove label" },
          goto_issue = { lhs = "<leader>gOig", desc = "navigate to a local repo issue" },
        ...
        pull_request = {
          ...
          squash_and_merge_pr = { lhs = "<leader>gOpsm", desc = "squash and merge PR" },
          rebase_and_merge_pr = { lhs = "<leader>gOprm", desc = "rebase and merge PR" },
          list_commits = { lhs = "<leader>gOpc", desc = "list PR commits" },
          list_changed_files = { lhs = "<leader>gOpf", desc = "list PR changed files" },
          show_pr_diff = { lhs = "<leader>gOpd", desc = "show PR diff" },
          add_reviewer = { lhs = "<leader>gOva", desc = "add reviewer" },
          remove_reviewer = { lhs = "<leader>gOvd", desc = "remove reviewer request" },
        ...
        review_diff = {
          ...
          add_review_comment = { lhs = "<leader>gOca", desc = "add a new review comment" },
          add_review_suggestion = { lhs = "<leader>gOsa", desc = "add a new review suggestion" },
          focus_files = { lhs = "<leader>gOe", desc = "move focus to changed file panel" },
          toggle_files = { lhs = "<leader>gOb", desc = "hide/show changed files panel" },
          ...
          select_last_entry = { lhs = "]Q", desc = "move to last changed file" },
          close_review_tab = { lhs = "<C-c>", desc = "close review tab" },
          toggle_viewed = { lhs = "<leader>gO<space>", desc = "toggle viewer viewed state" },
          goto_file = { lhs = "gf", desc = "go to file" },
        },
        file_panel = {
          submit_review = { lhs = "<leader>gOvs", desc = "submit review" },
    ...
    keys = {
      ...
      { "<leader>gOa", "", desc = "+assignee (Octo)", ft = "octo" },
      { "<leader>gOc", "", desc = "+comment/code (Octo)", ft = "octo" },
      { "<leader>gOl", "", desc = "+label (Octo)", ft = "octo" },
      { "<leader>gOi", "", desc = "+issue (Octo)", ft = "octo" },
      { "<leader>gOr", "", desc = "+react (Octo)", ft = "octo" },
      { "<leader>gOp", "", desc = "+pr (Octo)", ft = "octo" },
      { "<leader>gOv", "", desc = "+review (Octo)", ft = "octo" },
