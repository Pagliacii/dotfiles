...
if ok then
  wk.add({
    ...
    { "<leader>nqg", group = "global", icon = { icon = "󰣩 ", color = "orange" } },
    { "<leader>nqi", group = "import", icon = { icon = "󰈠 ", color = "orange" } },
    { "<leader>nqL", group = "list", icon = { icon = "󱒋 ", color = "orange" } },
    { "<leader>nqw", group = "cwd", icon = { icon = "󰈔 ", color = "orange" } },
    { "<leader>nqj", group = "jump", icon = { icon = " ", color = "orange" } },
    { "<leader>nql", group = "line", icon = { icon = " ", color = "orange" } },
    { "<leader>no", group = "neorg", icon = { icon = " ", color = "orange" } },
    { "<leader>nt", group = "typst", icon = { icon = "󰼭 ", color = "orange" } },
    { "<leader>nz", group = "telekasten", icon = { icon = "📔 ", color = "green" } },
